...
@interface PIPEnablerSettingsController : PSListController
{
	UILabel* _label;
	UILabel* underLabel;
}
...
@implementation PIPEnablerSettingsController
- (id)specifiers {
	if (!_specifiers) {
		NSMutableArray* specifiers = [NSMutableArray array];
		PSSpecifier* spec;
		
		spec = [PSSpecifier preferenceSpecifierNamed:@"Show Automatically in PIP"
                                                  target:self
                                                  ...
                                                  detail:Nil
											        cell:PSSwitchCell
											        edit:Nil];
		[spec setProperty:@"autoShowPIP" forKey:@"key"];
		...
		[spec setProperty:@"Action For Toggle Enter/Exit PIP mode." forKey:@"footerText"];
        [specifiers addObject:spec];
		...
		if (access("/usr/lib/libactivator.dylib", F_OK) == 0) {
			...
			[spec setProperty:@"com.julioverne.pipenabler" forKey:@"activatorListener"];
        ...
        [specifiers addObject:spec];
		spec = [PSSpecifier emptyGroupSpecifier];
        [spec setProperty:@"PIPEnabler © 2016" forKey:@"footerText"];
        [specifiers addObject:spec];
...
- (void)love
{
	...
	[twitter setInitialText:@"#PIPEnabler by @ijulioverne is cool!"];
	if (twitter != nil) {
...
- (void)reset
{
	...
	notify_post("com.julioverne.pipenabler/SettingsChanged");
...
- (void)HeaderCell
{
	@autoreleasepool {
		...
		[underLabel setText:@"Enabler Picture In Picture Feature"];
